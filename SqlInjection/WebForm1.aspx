...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <p>
            【考えてみよう】<br />
            パラメータ部に「aaa'; UPDATE [MyTable] SET [StringData] = 'ddd' WHERE [IntData] = '4」と入れるとどうなるか考えてみてください。<br />
            では、「aaa'; DELETE FROM MyTable WHERE '1' = '1」と入れると…？<br />
            <span style="color: red;">※ データが更新／削除されるので実行する場合には注意をしてください！！！</span>
            </p>
        </div>
    </form>
</body>
